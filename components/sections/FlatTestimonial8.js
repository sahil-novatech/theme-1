...
export default function FlatTestimonial8() {
	return (
		<>

			<section className="tf-section flat-testimonial style-6">
							...
							<div className="col-12">
								...
								<div className="box-testimonials">
									...
									<div className="testimonials-item background-white">
										<svg className="wow fadeInUp" xmlns="http://www.w3.org/2000/svg" width={45} height={44} viewBox="0 0 45 44" fill="none">
										...
										<div className="description wow fadeInUp">Searches for multiplexes, property
											comparisons, and the loan estimator. Works great. Lorem ipsum dolor sit
