...
export default function FlatTestimonial9() {
	return (
		<>

			<section className="tf-section flat-testimonial style-5 type-1">
							...
							<div className="col-12">
								...
								<div className="swiper-container slider-testimonials-1">
									<Swiper {...sliderTestimonials1}>
										<SwiperSlide>
											<div className="testimonials-item background-white type-1 wow fadeInUp">
												<div className="head">
													<div className="image">
										...
										<SwiperSlide>
											<div className="testimonials-item background-white type-1 wow fadeInUp" data-wow-delay="0.1s">
												<div className="head">
													<div className="image">
										...
										<SwiperSlide>
											<div className="testimonials-item background-white type-1 wow fadeInUp" data-wow-delay="0.2s">
												<div className="head">
													<div className="image">
										...
										<SwiperSlide>
											<div className="testimonials-item background-white type-1">
												<div className="head">
													<div className="image">
														<img src="/images/author/author-2.png" alt="" />
													</div>
