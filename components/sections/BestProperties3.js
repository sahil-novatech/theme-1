...
export default function BestProperties3() {
	return (
		<>

			<section className="tf-section best-properties style-1 type-2D3A4F">
				<div className="themesflat-container">
					<div className="row">
						<div className="col-12">
							<div className="heading-section text-center style-white">
								<h2 className="wow fadeInUp">Exclusive Properties</h2>
					...
					<div className="row">
						<div className="col-12">
							<div className="inner">
								<div className="properties-slider item-1">
								...
								<div className="properties-content-default item-2">
								...
								<div className="box-dream style-absolute type-no-bg-content style-properties item-4">
									<div className="image">
