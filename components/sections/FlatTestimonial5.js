...
export default function FlatTestimonial5() {
	...
	return (
		<>
			...
			<section className="tf-section flat-testimonial style-4">
				<div className="testimonials">
					<div className="thumbs-slider-second style-1">
						<div className="themesflat-container">
							<div className="row gap10 justify-between">
								<div className="col-lg-5">
									<Swiper {...thumbnailSwiperOptions} onSwiper={setThumbsSwiper} className="swiper-container slider-thumbs-gallery-second-2 padding-bottom-80 arrow-style-1 pagination-style-number">
										<div className="swiper-wrapper">
											<SwiperSlide>
												<div className="testimonials-item style-white">
													<div className="head">
														<div className="image">
													...
													<div className="description">Searches for multiplexes, property
														comparisons, and the loan estimator. Works great. Lorem
														ipsum dolor sit amet, consectetur adipiscing elit, sed do
														eiusmod tempor incididunt ut labore et dores.</div>
										...
										<div className="bottom-wrap">
											<div className="thumbs-gallery-prev type-white has-border swiper-button-prev">
											</div>
											<div className="swiper-pagination type-white thumbs-gallery-pagination">
											</div>
											<div className="thumbs-gallery-next type-white has-border swiper-button-next">
											</div>
										</div>
									</Swiper>
								</div>
								<div className="col-lg-5">
									<Swiper {...mainSwiperOptions} className="swiper-container slider-thumbs-gallery-second-1">
										<div className="swiper-wrapper">
											<SwiperSlide>
												<div className="video-wrap item-3">
													<img src="/images/image-box/testimonial-3.jpg" alt="" />
