...
export default function SliderTestimonial({ styleWhite }) {
	return (
		<>
			<Swiper {...sliderTestimonials}>
				<SwiperSlide>
					<div className={`testimonials-item ${styleWhite ? "style-white" : ""}`}>
						<div className="head">
						...
						<div className="description wow fadeInUp">Searches for multiplexes,
							property comparisons, and the loan estimator. Works great. Lorem
			...
			<div className="bottom-wrap">
				<div className={`testimonials-prev ${styleWhite ? "type-white" : ""} has-border swiper-button-prev`}>
				</div>
				<div className={`swiper-pagination ${styleWhite ? "type-white" : ""} testimonials-pagination`} />
				<div className={`testimonials-next ${styleWhite ? "type-white" : ""} has-border swiper-button-next`}>
				</div>
			</div>
		</>
	)
