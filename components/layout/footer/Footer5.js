...
export default function Footer5() {
	return (
		<>
			...
			<footer className="footer style-full bg-white">
				<div className="footer-inner">
					<div className="footer-inner-wrap style-container">
						...
						<div className="center-footer">
							<div className="footer-cl-1">
								...
								<form className="form-subscribe style-line-bottom">
									...
									<div className="button-submit style-absolute-right">
										<button className="tf-button-bg type-secondary" type="submit">Send <i className="icon-arrow-right-add" /></button>
									</div>
								</form>
							...
							<div className="footer-cl-6">
								...
								<ul className="ft-download bg-fourth type-secondary">
									<li>
										<a href="#">
											<div className="icon">
