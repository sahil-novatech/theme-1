...
export default function Header3({ scroll, isMobileMenu, handleMobileMenu, isLogin, handleLogin, isRegister, handleRegister }) {
	return (
		<>

			<header id="header_main" className={`header header-fixed style-no-bg type-home3 style-absolute ${scroll ? "is-fixed is-small" : ""}`}>
