...
export default function Header10({ scroll, isMobileMenu, handleMobileMenu, isLogin, handleLogin, isRegister, handleRegister }) {
	return (
		<>

			<header id="header_main" className={`header header-fixed style-no-bg style-absolute type-home10 ${scroll ? "is-fixed is-small" : ""}`}>
					...
					<div className="header-inner-wrap">
						...
						<div className="header-right">
							...
							<div className="header-btn">
								<Link href="/dashboard-add-properties" className="tf-button-default style-white active">Add
									Listing</Link>
							</div>
						</div>
