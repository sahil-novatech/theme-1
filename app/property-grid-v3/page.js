...
export default function PropertyGridV3() {
		...
		<>
			...
			<Layout headerStyle={12} footerStyle={1} mainContentCls="px-20">
				<div>
					...
					{/* flat-title */}
					<div className="flat-title page-property-grid-3">
					...
					{/* /flat-title */}
					{/* property-grid */}
					<div className="property-grid-wrap-v3">
						<div className="themesflat-container">
							<div className="row">
								<div className="col-12">
									<div className="top">
							...
							<div className="row">
								<div className="col-xl-3 col-md-6">
									<div className="box-dream style-1 wow fadeInUp">
										<div className="image-group relative">
								...
								<div className="col-xl-3 col-md-6">
									<div className="box-dream style-1 wow fadeInUp" data-wow-delay="0.1s">
										<div className="image-group relative">
											<div className="list-tags">
								...
								<div className="col-xl-3 col-md-6">
									<div className="box-dream style-1 wow fadeInUp" data-wow-delay="0.2s">
										<div className="image-group relative">
											<div className="list-tags">
												<Link href="/#" className="tags-item for-sell">FOR SELL</Link>
											</div>
								...
								<div className="col-xl-3 col-md-6">
									<div className="box-dream style-1 wow fadeInUp" data-wow-delay="0.3s">
										<div className="image-group relative">
											<div className="list-tags">
												<Link href="/#" className="tags-item for-sell">FOR SELL</Link>
											</div>
								...
								<div className="col-xl-3 col-md-6">
									<div className="box-dream style-1 wow fadeInUp">
										<div className="image-group relative">
											...
											<div className="button-heart"><i className="flaticon-heart-1" /></div>
											<div className="swiper-container slider-box-dream arrow-style-1 pagination-style-1">
												<SliderBoxDream path="house/property-listing" start={10} end={12} />
											</div>
										</div>
										<div className="content">
											<div className="head">
								...
								<div className="col-xl-3 col-md-6">
									<div className="box-dream style-1 wow fadeInUp" data-wow-delay="0.1s">
										<div className="image-group relative">
											...
											<div className="button-heart"><i className="flaticon-heart-1" /></div>
											<div className="swiper-container slider-box-dream arrow-style-1 pagination-style-1">
												<SliderBoxDream path="house/property-listing" start={11} end={13} />
											</div>
										</div>
										<div className="content">
											<div className="head">
