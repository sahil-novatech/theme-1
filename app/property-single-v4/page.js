...
export default function PropertySingleV4() {

	return (
		<>

			<Layout headerStyle={12} footerStyle={1} mainContentCls="default">
				<div className="property-single-wrap v4">
					...
					<div className="swiper-container slider-3-center">
						<Swiper {...slider3Center}>
							<SwiperSlide>
								<img src="/images/slider/slider-properties-detail-8.jpg" alt="" />
							</SwiperSlide>
							<SwiperSlide>
								<img src="/images/slider/slider-properties-detail-9.jpg" alt="" />
							</SwiperSlide>
							<SwiperSlide>
								<img src="/images/slider/slider-properties-detail-10.jpg" alt="" />
							</SwiperSlide>
							<SwiperSlide>
								<img src="/images/slider/slider-properties-detail-8.jpg" alt="" />
							</SwiperSlide>
							...
							<div className="col-xl-8">
								<div className="content-wrap">
									<div className="head-title">
										<div>
											<div className="list-tags wow fadeInUp">
										...
										<div>
											<div className="square wow fadeInUp">$ 1,098 /sq ft</div>
									...
									<div className="smilar-homes">
										<h4 className="wow fadeInUp">Similar Homes</h4><div className="row">
