						...
						<div className="row">
							...
							<div className="col-12">
								<div className="wrap-gallery-image">
									...
									<Link href="/images/house/property-detail-1.jpg" className="item-1" data-fancybox="gallery">
										<img src="/images/house/property-detail-1.jpg" alt="" />
									</Link>
									<Link href="/images/house/property-detail-2.jpg" className="item-2" data-fancybox="gallery">
										<img src="/images/house/property-detail-2.jpg" alt="" />
									</Link>
									<Link href="/images/house/property-detail-3.jpg" className="item-3" data-fancybox="gallery">
										<img src="/images/house/property-detail-3.jpg" alt="" />
									</Link>
									<Link href="/images/house/property-detail-4.jpg" className="item-4" data-fancybox="gallery">
										<img src="/images/house/property-detail-4.jpg" alt="" />
									</Link>
									<Link href="/images/house/property-detail-5.jpg" className="item-5" data-fancybox="gallery">
										<img src="/images/house/property-detail-5.jpg" alt="" />
									</Link>
									<Link href="/images/house/property-detail-3.jpg" className="more-photos" data-fancybox="gallery">
											...
											<div className="col-md-6">
												<div className="box-dream has-border wow fadeInUp" data-wow-delay="0.1s">
													<div  className="image-group relative">
														...
														<div className="button-heart"><i className="flaticon-heart-1" /></div>
														<div className="swiper-container slider-box-dream arrow-style-1 pagination-style-1">
															<SliderBoxDream path="house/home" start={2} end={5} />
														</div>
													</div>
													<div className="content">
														<div className="head">
