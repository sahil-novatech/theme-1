...
export default function PropertySingleV2() {
	...
	return (
		<>
			...
			<Layout headerStyle={12} footerStyle={1}>
				<div className="property-single-wrap v2">
						...
						<div className="row">
							...
							<div className="col-12">
								<div className="head-title">
									...
									<div className="wow fadeInUp">
										<div className="square">Price</div>
							...
							<div className="col-xl-8">
								<div className="content-wrap">
									<div className="thumbs-slider arrow-style-1">
										<Swiper {...mainSwiperOptions} className="swiper-container slider-thumbs-gallery-2">
											<div className="swiper-wrapper">
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-1.jpg" alt="" />
												</SwiperSlide>
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-1.jpg" alt="" />
												</SwiperSlide>
										...
										<Swiper {...thumbnailSwiperOptions} onSwiper={setThumbsSwiper} className="swiper-container slider-thumbs-gallery-1">
											<div className="swiper-wrapper">
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-2.jpg" alt="" />
												</SwiperSlide>
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-3.jpg" alt="" />
												</SwiperSlide>
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-4.jpg" alt="" />
												</SwiperSlide>
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-5.jpg" alt="" />
												</SwiperSlide>
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-6.jpg" alt="" />
												</SwiperSlide>
												<SwiperSlide>
													<img src="/images/slider/slider-properties-detail-7.jpg" alt="" />
												</SwiperSlide>
											</div>
										</Swiper>
									</div>
									...
									<div className="features">
										...
										<ul>
											<li>
												...
												<div className="wrap-check-ellipse wow fadeInUp">
