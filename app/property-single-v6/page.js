...
export default function PropertySingleV6() {
		...
		<>
			...
			<Layout headerStyle={12} footerStyle={1} mainContentCls="px-20">
				<div>
					...
					<div className="property-single-wrap v6">
						<div className="swiper-container slider-property-single-6 arrow-style-1">
							<Swiper {...sliderPropertySingle6}>
								<SwiperSlide>
									<div className="swiper-item">
										<div className="image-group relative">
											<img src="/images/slider/slider-properties-detail-17.jpg" alt="" />
										</div>
									</div>
								</SwiperSlide>
								<SwiperSlide>
									<div className="swiper-item">
										<div className="image-group relative">
											<img src="/images/slider/slider-properties-detail-18.jpg" alt="" />
										</div>
									</div>
								</SwiperSlide>
							</Swiper>
							...
							<div className="head-title style-white">
								<div className>
									<div className="list-tags position-unset">
										<Link href="/#" className="tags-item for-sell">FOR RENT</Link>
										<Link href="/#" className="tags-item featured">FEATURED</Link>
									</div>
									<h3 className>Villa One Hyde Park</h3>
								...
								<div>
									<div className="list-icons-page style-white">
										<div className="item">
											<div className="icon">
						...
						<div className="list-icons-page show-mobile">
							<div className="item">
								<div className="icon">
									<i className="flaticon-heart" />
								</div>
						...
						<div className="themesflat-container">
							<div className="row">
								...
								<div className="col-xl-4">
									<div className="property-single-sidebar has-background">
